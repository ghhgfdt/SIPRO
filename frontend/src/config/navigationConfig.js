...
import {
  ...
  Building, Banknote, Coins, SlidersHorizontal, BarChart3, Handshake, Megaphone, Target, FileSignature,
...
export const PAGE_META = {
  ...
  "/fund-requests": { kicker: "Keuangan", title: "Pengajuan Keuangan" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "petty-cash", label: "Kas Bon", icon: Coins, path: "/petty-cash", roles: ALL,
        resource: "petty_cash" },
      { id: "fund-requests", label: "Pengajuan", icon: FileSignature, path: "/fund-requests", roles: ALL,
        resource: "fund_request" },
